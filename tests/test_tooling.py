...
def make_wheel(tmp_path: Path, defect: str = "none") -> Path:
    ...
    contents = {
        ...
        "visualworld/evidence.py": b"",
        "visualworld/experimental.py": b"",
        "visualworld/frame_access.py": b"",
        ...
        "visualworld/storage.py": b"",
        "visualworld/tracking.py": b"",
        "visualworld/world_store.py": b"",
        "visualworld/world_store_v2.py": b"",
