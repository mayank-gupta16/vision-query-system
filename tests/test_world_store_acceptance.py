...
"""Tests for the local WorldStore CPU-LITE acceptance harness."""
...
def test_world_store_acceptance_emits_redacted_machine_receipt(tmp_path: Path) -> None:
    ...
    assert receipt["schema"] == "visualworld.world-store-acceptance-receipt"
    assert receipt["workload"]["frame_count"] == 12
