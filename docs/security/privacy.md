...
need. Crop representations, diagnostics, structured failures, and metadata
mappings omit those bytes; durable custody still requires the accepted
EvidenceStore/coordinator path.
